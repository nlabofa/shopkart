...
function ajaxWish(e) {
    ...
    console.log(this);
    _axios2.default.post(this.action).then(function (res) {
        var isAdded = _this.wishlist.classList.toggle('wishearted');
        (0, _bling.$)('.wishlist-count').textContent = res.data.wishlist.length;
        //console.log(res.data.wishlist.length);

        if (isAdded) {
            _this.wishlist.classList.add('wishearted');
        }
    }).catch(console.error);
}

exports.default = ajaxWish;
...
var _wishlist = __webpack_require__(12);

var _wishlist2 = _interopRequireDefault(_wishlist);

var _addtocart = __webpack_require__(10);
